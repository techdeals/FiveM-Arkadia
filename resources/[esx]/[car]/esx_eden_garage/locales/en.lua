Locales['en'] = {
    ...
    ['spawn'] = 'Press ~INPUT_PICKUP~ for ~g~take out~s~ a vehicle',
    ['delete'] = 'Press ~INPUT_PICKUP~ for ~r~store~s~ a vehicle',
    ['pound_action_menu'] = 'Press ~INPUT_PICKUP~ for to ~g~access~s~ the impound',
    ['not_enough_money'] = 'You do not have ~r~enough money',
    ['impound_list'] = '%s: Return',
    ['impound_yard'] = 'Impounds',

    -- menu
    ['list_vehicles'] = 'List of vehicles',
    ['storing_vehicle'] = 'Store the vehicle',
    ['inpound'] = 'Impound',
    ['your_vehicles'] = 'Your vehicles',
    ['store'] = 'Store',
    ['inpound_vehicles'] = 'Inpound Vehicles',
    ['none_vehicle'] = 'You have to be in a vehicle !'
}
